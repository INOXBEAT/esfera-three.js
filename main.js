...
// movimiento de la esfera con el clic
let isMouseDown = false;

// Agregar evento de clic a la esfera
sphere.addEventListener('mousedown', function() {
    console.log("Clic sostenido");
    isMouseDown = true;
});

// Agregar evento de soltar el clic a la esfera
sphere.addEventListener('mouseup', function() {
    console.log("Clic liberado");
    isMouseDown = false;
});
